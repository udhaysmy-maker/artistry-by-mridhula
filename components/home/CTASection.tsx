  ...
  return (
    <section className="mx-auto max-w-4xl px-5 py-20 text-center">
      ...
      <p className="mx-auto mt-4 max-w-lg text-muted-foreground">
        Whether it&apos;s your wedding day or a special occasion, I&apos;d love
        to be a part of your story. Reach out to check availability and start
        planning your beauty experience.
      </p>
